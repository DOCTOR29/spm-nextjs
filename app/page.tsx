...
function App() {
  useEffect(() => {
    ...
    const handleParallax = () => {
      const banner = document.querySelector('.parallax-bg');
      if (banner) {
        const scrolled = window.scrollY;
        banner.style.setProperty('--parallax-offset', `${scrolled * 0.1}px`);
      }
    };
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Banner with Logo */}
      <div className="bg-gradient-to-r from-blue-900 to-indigo-900 text-white py-4 shadow-md">
        <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex flex-col sm:flex-row items-center space-y-2 sm:space-y-0 sm:space-x-6">
            <a href="tel:+919435000000" className="flex items-center hover:text-amber-300 transition-colors">
              <span className="mr-2 text-amber-400">📞</span>
              <span>+91 94350 00000</span>
            </a>
            <a href="mailto:info@spmandlalans.com" className="flex items-center hover:text-amber-300 transition-colors">
      ...
      <div className="relative h-[300px] md:h-[450px] w-full overflow-hidden">
        ...
        <div className="container mx-auto px-4 h-full flex items-center">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div className="text-white z-10 banner-fade-in">
              <h2 className="text-3xl md:text-5xl font-bold mb-4 text-shadow">Excellence in Education</h2>
              <p className="text-xl mb-6 text-shadow">Join the best coaching institute for JEE and NEET preparation in Guwahati</p>
              <div className="flex flex-wrap gap-4">
                <a href="#programs" className="bg-amber-500 hover:bg-amber-600 text-gray-900 font-bold px-6 py-3 rounded-md transition-colors shadow-lg hover:shadow-xl transform hover:scale-105">Our Programs</a>
                <a href="#results" className="bg-transparent border-2 border-white hover:bg-white hover:text-blue-900 px-6 py-3 rounded-md transition-colors shadow-lg hover:shadow-xl transform hover:scale-105">View Results</a>
              </div>
            </div>
            <div className="hidden md:flex items-center justify-center banner-fade-in" style={{ animationDelay: '0.5s' }}>
              ...
              <div className="relative h-64 w-64 ml-4 rounded-lg overflow-hidden shadow-2xl transform hover:scale-105 transition-transform">
                <Image
                  src="/banner/side.jpg"
        ...
        {/* Mobile-friendly side image */}
        <div className="md:hidden absolute bottom-0 right-0 w-1/2 h-1/2">
          <div className="relative h-full w-full">
            <Image
              src="/banner/side.jpg"
              alt="Students studying"
              fill
              style={{ objectFit: 'cover', borderTopLeftRadius: '2rem' }}
            />
        ...
        <div className="md:hidden absolute top-4 right-4 w-24 h-24">
          <div className="relative h-full w-full">
            <Image
              src="/spm-and-lalans-logo-removebg-preview.png"
              alt="SPM and Lalans Logo"
