...
//                 </div>
//                 <div>
//                   <Select className="w-full bg-white/10 border-white/20 text-white">
//                     <option value="">Select Course</option>
//                     <option value="pre-foundation">Pre-Foundation Course</option>
//                     <option value="foundation">Foundation Course</option>
//                     <option value="fresher">Fresher Course</option>
//                     <option value="dropper">Dropper Course</option>
