  ...
  return (
    <div className="rounded-xl overflow-hidden shadow-lg group hover:shadow-xl transition-all duration-300">
      <div className="h-48 overflow-hidden relative">
        ...
        />
        <div className="absolute inset-0 bg-[#184587]/90 group-hover:bg-[#F4D605]/90 transition-all duration-300"></div>
        <div className="absolute bottom-0 left-0 p-4 text-white">
          <div className="flex items-center">
            <div className="mr-3 text-[#F4D605] group-hover:text-[#184587] transition-colors duration-300">{icon}</div>
            <h3 className="font-bold text-lg group-hover:text-[#184587] transition-colors duration-300">{title}</h3>
          </div>
        </div>
      </div>
...
const Facilities: React.FC = () => {
  ...
  return (
    <section id="facilities" className="relative py-16 md:py-24 bg-[#F4D605]/5">
      <div className="container mx-auto px-4 md:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-[#184587]">
